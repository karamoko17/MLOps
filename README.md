...
The application has been deployed on **Streamlit Cloud**, offering an interactive interface accessible via the following link: [Access the application](https://irispredictionappawakaramoko.streamlit.app/) or [https://irispredictionappawakaramoko.streamlit.app/](https://irispredictionappawakaramoko.streamlit.app/). 
